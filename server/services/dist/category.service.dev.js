...
module.exports = {
  ...
  create: function create(req, res, next) {
    var _req$body, name, description, category;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return regeneratorRuntime.awrap(Category.findByIdAndDelete({
              _id: id
            }));
  ...
  update: function update(req, res, next) {
    var id, _req$body2, name, description, newCategory, category;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 6;
            return regeneratorRuntime.awrap(Category.findByIdAndUpdate({
              _id: id
            }, newCategory, {
              "new": true
            }));
